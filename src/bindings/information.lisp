...
(defparameter *cl-device-info-types*
  `((,+cl-device-type+ . cl-device-type)
    ...
    (,+cl-device-max-work-group-size+ . cl-size)
    ;;+cl-device-max-work-item-sizes+ vector-class< cl-size>
    ...
    (,+cl-device-image2d-max-width+ . cl-size)
    (,+cl-device-image2d-max-height+ . cl-size)
    (,+cl-device-image3d-max-width+ . cl-size)
    (,+cl-device-image3d-max-height+ . cl-size)
    (,+cl-device-image3d-max-depth+ . cl-size)
    (,+cl-device-image-support+ . cl-bool)
    (,+cl-device-max-parameter-size+ . cl-size)
    ...
    (,+cl-device-profiling-timer-resolution+ . cl-size)
    ...
    (,+cl-device-preferred-interop-user-sync+ . cl-size)
